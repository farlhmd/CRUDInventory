package com.kelompok2.crudinventory.adapter
...
import com.kelompok2.crudinventory.holder.MainViewHolder
...
class MainAdapter(private val context: Context,
    ...
    override fun onBindViewHolder(holder: MainViewHolder, position: Int) {
        ...
        holder.merkBarang.text = "Merk     : " + daftarBarang?.get(position)?.stok
